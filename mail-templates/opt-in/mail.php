            ...
            <table border="0" cellpadding="0" cellspacing="0" width="650">
                <tr>
                    <td align="left" valign="bottom" bgcolor="#595959" style="text-align: left; font-size: 16px; background-color: #595959; color: #fff; padding: 4px;">
                        An exclusive invitation from<br />
                    ...
                    <td align="right" bgcolor="#595959" style="text-align: right; background-color: #595959; padding: 4px;">
                        <img src="<?php echo BOGOBLAST_URL; ?>mail-templates/opt-in/img/bogoblast-logo.gif" alt="Bogoblast.com" />
                    </td>
                </tr>
                <tr>
                            ...
                            <table width="100%">
                                <tr>
                                    <td align="center" valign="top" width="40%" style="text-align: center; vertical-align: top; color: #000; font-size: 18px;">
                                        <p><?php Bogoblast::post_thumbnail($bogoblast_business->ID, array(200,200), 3); ?><p>
                                    ...
                                    <td align="center" width="60%" style="text-align: center;">
                                        <div style="color: #000; font-size: 22px;">
                                            <p><?php echo $bogoblast_business->post_title; ?> would like to share exclusive discounts, events, and other great offers with you twice a month.</p>
                                            <p>There’s no obligation or purchase required, and you can opt-out at any time.</p>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2" style="text-align: center; font-size: 13px;">
                                        <a href="<?php echo get_permalink($bogoblast_business->ID); ?>?subscribe_method=optin-email&bogoblast_new_subscriber_email=[[subscriber_email]]">
                                            <img src="<?php echo BOGOBLAST_URL; ?>mail-templates/opt-in/img/put-me-on-the-list.png" alt="Put Me on the List!"><br />
                                ...
                                <tr>
                                    <td colspan="2" style="color: #595959; font-size: 12px;">
                                        Expires <?php echo date_i18n(get_option('date_format'), $promotion_expiration); ?>.
                ...
                <tr>
                    <td align="left" valign="bottom" bgcolor="#6cd420" colspan="2" style="text-align: left; font-size: 22px; background-color: #8EBC45; color: #fff; padding: 12px;">
                        <a href="<?php echo get_site_url() ?>/businesses?utm_source=bogoblast&utm_medium=email&utm_campaign=email_footer_directory_link" style="color: #fff; font-weight: bold; text-decoration: none;">Click here to see more great local deals at BogoBlast.com!</a>
                    </td>
                </tr>
                <tr>
